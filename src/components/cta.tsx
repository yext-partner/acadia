...
const Cta = (props: Cta) => {
  ...
  return (
    <a
      href={url}
      className={`${display} text-${fontColor} py-4 px-6 text-2xl font-bold rounded-lg border-4 border-gray-800 no-underline hover:cursor-pointer hover:no-underline`}
